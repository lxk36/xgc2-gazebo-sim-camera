...
Depends: ros-noetic-gazebo-plugins, ros-noetic-gazebo-ros, ros-noetic-rospy, ros-noetic-roslaunch, ros-noetic-rostopic, ros-noetic-rviz, ros-noetic-sensor-msgs, ros-noetic-tf, ros-noetic-xacro, ros-noetic-xgc2-gazebo-sim-worlds (>= 1.1.0-11), ros-noetic-xgc2-gazebo-sim-vrpn-bridge (>= 1.1.0-13)
